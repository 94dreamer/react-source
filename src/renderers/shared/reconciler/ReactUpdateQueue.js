...
// 由用户自定义组件ReactComponent实例publicInstance，获取对应的ReactCompositeComponent实例
function getInternalInstanceReadyForUpdate(publicInstance, callerName) {
  // 由用户自定义组价ReactComponent实例publicInstance，组件对象
  // 获得react内部使用ReactCompositeComponent实例internalInstance
  // Map的数据结构拿到自定义组件映射
  var internalInstance = ReactInstanceMap.get(publicInstance);
  // ReactInstanceMap 是组件渲染时候保存的 ReactInstanceMap.set(inst, this);
